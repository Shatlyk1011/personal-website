...
export default function Home() {
  return (
    <>
      ...
      <main className="min-h-svh w-full bg-bg-black px-[12rem] pt-[8rem] text-gray-1">
        <section className="flex h-full w-full">
          {/* left */}
          <div className="flex flex-1 flex-col gap-[14rem] pt-[7.4rem] pr-[7.4rem] pb-[4rem]">
            <div>
            ...
            <div className="flex flex-col gap-[3.2rem] text-[1.4rem] tracking-[-0.04em] text-gray-1">
              <ul>
          ...
          <div className="w-full flex-[1.1] py-[3.2rem] pl-[7.4rem]">
            <CustomForm />
          </div>
        </section>
