...
const Services = () => {
  return (
    <section id="services" className="bg-bg-black pt-[12.4rem] px-[7.4rem] portrait:px-[4rem] portrait:pt-[8rem] text-gray-1" >
      <div className="max-w-[144rem] mx-auto">

        <div className="flex flex-col gap-[6.4rem] portrait:gap-[3.2rem] pb-[3.2rem] ">
